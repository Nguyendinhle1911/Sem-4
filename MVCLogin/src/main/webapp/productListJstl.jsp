        ...
        <c:forEach var="product" items="${products}">
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-update btn-sm" data-bs-toggle="modal" data-bs-target="#updateModal${product.id}">
                        <i class="fa fa-edit"></i> Update
                    </button>
                    <div class="modal fade" id="updateModal${product.id}" tabindex="-1" aria-labelledby="updateLabel" aria-hidden="true">
